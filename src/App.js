    ...
    function App() {
      ...
      return (
        <div className="parks">
          ...
          {parks.length > 0 && (
            <Card
            name={parks[current][0].fullName}
            img={parks[current][0].images}
            caption={parks[current].caption}
            desc={parks[current].description}
            weather={parks[current].weatherInfo}
